...
import { getContactById, updateContactById } from '../../store/contacts-actions';
...
const AddContact = () => {
  ...
  const contactForEdit = useSelector((state) => state.contacts.contactDetail);
    ...
    <Container component="main" maxWidth="xs" margin={5}>
      <Formik
        ...
        onSubmit={(values, { resetForm }) => {
          ...
          dispatch(updateContactById(params.id, newValues));
          resetForm();
          history.push('/kontakt/detalji/' + params.id);
        }}
      >
        {(props) => (
          <Box mt={5}>
